...
export class Modals {
  ...
  _documentKeydownHandler(evt) {
    ...
    if (isEscKey) {
      evt.preventDefault();
      this.close(document.querySelector('.modal.modal--active').dataset.modal);
    }
  }
  ...
  open(modalName = this._modalName) {
    ...
    this._openedModalElement = document.querySelector('.modal.modal--active');
    ...
    if (this._lockFocus) {
      this._focusLock.lock('.modal.modal--active', this._startFocus);
    }
